...
if mask == True:
    ...
    Data_01=np.load("../imread_01x"+str(lens)+"_mask.npy",allow_pickle=True)[:len(Data_02Nami)]
else:
    Data_02Nami=np.load("../imread_02Namix"+str(lens)+"_nomask.npy",allow_pickle=True)
    Data_01=np.load("../imread_01x"+str(lens)+"_nomask.npy",allow_pickle=True)[:len(Data_02Nami)]
...
print("DataPad_02Nami: ",len(DataPad_02Nami), flush=True)
print("")
